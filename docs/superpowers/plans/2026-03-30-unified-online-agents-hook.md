...
```bash
git add src-tauri/src/daemon/codex/ws_client.rs src-tauri/src/daemon/codex/session.rs src-tauri/src/daemon/codex/runtime.rs src-tauri/src/daemon/codex/mod.rs src-tauri/src/daemon/state.rs src-tauri/src/daemon/state_tests.rs docs/dimweave-audit-summary.md docs/agents/codex-chain.md
...
```bash
git add src-tauri/src/daemon/routing.rs src-tauri/src/daemon/routing_tests.rs src-tauri/src/daemon/routing_behavior_tests.rs docs/dimweave-audit-summary.md
...
```bash
git add docs/dimweave-audit-summary.md docs/agents/codex-chain.md docs/agents/claude-chain.md
